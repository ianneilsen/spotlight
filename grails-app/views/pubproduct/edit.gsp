...
<html>
	...
	<body>
		<a href="#edit-pubproduct" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
    ...
    <div class="navbar1">
		...
		<div id="edit-pubproduct" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${pubproductInstance?.version}" />
				<fieldset class="form">
