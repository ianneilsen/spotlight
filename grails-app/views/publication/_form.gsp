...
<div class="row">
    <div class="span2"><div class="fieldcontain ${hasErrors(bean: publicationInstance, field: 'publicationName', 'error')} required">
            <g:message code="publication.publicationName.label" default="Publication Name(Required)" />
    </div>
    </div>
        <div class="span4"><g:textField name="publicationName" maxlength="100" required="" value="${publicationInstance?.publicationName}"/></div>
</div>
