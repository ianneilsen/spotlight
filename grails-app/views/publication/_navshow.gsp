    ...
    <!----actions --->
        ...
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                ...
                <a href="SpotLight-Grails/publication/exporttohtml"  data-toggle="modal">Export to ODT</a>
                <a href="SpotLight-Grails/publication/exporttohtml"  data-toggle="modal">Export to Text</a>
