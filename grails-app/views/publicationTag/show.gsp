		...
		<div id="show-publicationTag" class="content scaffold-show" role="main">
			...
			<ol class="property-list publicationTag">
				...
				<li class="fieldcontain">
					<span id="pubtagname-label" class="property-label"><g:message code="publicationTag.pubtagname.label" default="Pub Tag Name" /></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:actionSubmit class="delete" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure you want to delete this tag?')}');" />
				</fieldset>
			</g:form>
		</div>
	</body>
