<%@ page import="spotlight.content.Portfolio; spotlight.content.Publication" %>
...
<div class="property-list portfolio">
    ...
    <g:if test="${portfolios}">
        <% notarchivedportfolios = Portfolio.findAllByStatus("Active",[sort: "lastUpdated", order: "desc", offset: 0])%>
<g:each in="${notarchivedportfolios}" status="i" var="portfolioInstance">
