...
@TestFor(ReportTagController)
@Mock(ReportTag)
class ReportTagControllerTests {
    ...
    void testShow() {
        ...
        populateValidParams(params)
        def reportTag = new ReportTag(params)
    ...
    void testDelete() {
        ...
        assert ReportTag.count() == 0
        assert ReportTag.get(reportTag.id) == null
        assert response.redirectedUrl == '/reportTag/list'
    }
}
