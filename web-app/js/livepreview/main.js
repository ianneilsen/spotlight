...
$(function() {
  ...
  $('#publicationcontent').val(example);
  $('#output').html(markdown.toHTML(example));
  $('#publicationcontent').bind('keyup', function() {
    isEdited = true;
    $('#output').html(markdown.toHTML($('#publicationcontent').val()));
  });
